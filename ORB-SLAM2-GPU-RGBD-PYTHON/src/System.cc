...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               const bool bUseViewer, const std::string &map_file, bool load_map)
...
void System::Shutdown()
{
    ...
    std::cout << "LocalMap closed" << std::endl;
    mpLoopCloser->RequestFinish();
    std::cout << "Loopcloser closed" << std::endl;

    if (mpViewer) {
	mpViewer->RequestFinish();
    std::cout << "request Viewer close" << std::endl;
...
// ICI POUR LA MAP
vector<MapPoint*> System::GetAllMapPts() const
{
    return mpMap->GetAllMapPoints();
}

// ICI POUR LES REF PTS
vector<MapPoint*> System::GetAllRefMapPoints() const
{
    return mpMap->GetReferenceMapPoints();
} 

// ICI POUR L'image
cv::Mat System::GetOrbFrame() const
{
